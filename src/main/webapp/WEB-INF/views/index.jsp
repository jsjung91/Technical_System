...
<body>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<li class="nav-item"><a class="nav-link js-scroll-trigger"
			...
			<!-- <li class="nav-item"><a class="nav-link js-scroll-trigger"
				href="/boardboot/tech/tech_list?contentPage=technology_list.jsp">IT Request</a></li> -->
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
			...
			<li class="nav-item"><a class="nav-link js-scroll-trigger"
				href="#skills">Asset</a></li>
			<li class="nav-item"><a class="nav-link js-scroll-trigger"
				href="#interests">Log</a></li>
			<li class="nav-item"><a class="nav-link js-scroll-trigger"
				href="/boardboot/board/list?contentPage=list.jsp">Report</a></li>
		</ul>
	</div>
	</nav>
	...
	<!-- <div class="container-fluid p-0">
		...
		<div class="my-auto">
			<h1 class="mb-0">
				<span class="text-primary">MTOS</span> ITMS
			</h1>
			<div class="subheading mb-5">
				Nice to meet you MTOS Fault handling system. 
			</div>
			...
			<ul class="list-inline list-social-icons mb-0">
				...
				<li class="list-inline-item"><a href="/boardboot/login/loginPage"> <span
						class="fa-stack fa-lg"> <i class="fa fa-circle fa-stack-2x"></i>
