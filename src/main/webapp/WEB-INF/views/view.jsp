...
function del(){
		...
		if(c_pwd == "${ vo.pwd }"){
			...
			location.href="/boardboot/board/delete/${vo.idx}";
		}
	...
	<form name="f" method="post">
		<table width="690" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="td_d_2"><p><a href="/boardboot/board/fileDown/${ files.idx }">${files.fileOriName}</a></p></td>
			</tr>
			<tr>
		...
		<table width="690" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<%-- <img src="../../img/btn_list.gif" 
					...
					<img src='/boardboot/img/btn_back.gif' onClick='location.href="/boardboot/board/list"' style="cursor:pointer"></td>
			</tr>
		</table>
	</form>          	   
</body>
